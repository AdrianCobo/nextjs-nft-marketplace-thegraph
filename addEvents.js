...
async function main() {
    ...
    let itemListedOptions = {
        ...
        sync_historical: true, //para ver los eventos del pasado del contrato
        topic: "ItemListed(address,address,uint256,uint256)",
        address: contractAddress,
        abi: {
            //del evento solo. Esto se obtiene de proyectoconloscontratosnft/artifacts/contracts/NftMarketplace.sol/NftMarketplace.json
            anonymous: false,
            inputs: [
                {
                    indexed: true,
